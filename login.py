...
ticket = main.doLogin(os.environ['M202271385'],os.environ['Yth88861072'],"http://access.hust.edu.cn/IDKJ-P/P/studentApi")
print(os.environ['M202271385'],os.environ['Yth88861072'])
#print(ticket)
