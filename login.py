...
ticket = main.doLogin(os.environ['USERNAME'],os.environ['Yth88861072'],"http://access.hust.edu.cn/IDKJ-P/P/studentApi")
print(os.environ['USERNAME'],os.environ['Yth88861072'])
#print(ticket)
